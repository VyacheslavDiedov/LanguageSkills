...
namespace DataAccessLayer.DataBaseModels
{
    public partial class Language
    {
        public Language()
        {
            ...
            LanguageTranslationLanguageInitials = new HashSet<LanguageTranslation>();
            LanguageTranslationLanguageToTranslates = new HashSet<LanguageTranslation>();
        ...
        public virtual ICollection<LanguageTranslation> LanguageTranslationLanguageInitials { get; set; }
        public virtual ICollection<LanguageTranslation> LanguageTranslationLanguageToTranslates { get; set; }
